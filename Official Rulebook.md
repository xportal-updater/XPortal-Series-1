...
## Registration
Teams must register via www.xpseries.com. A registration fee of €600 +VAT per team (covers 5 players + 1 coach) is required to confirm entry. Registration is first-come, first-served and is open to all teams. Once 16 teams register, sign-ups will close. Sign ups close automatically on March 5th, 23:59.
...
In line with Valve’s guidelines for Tier 2 events, XPORTAL Series #1 will use VRS rankings to seed teams into the Main Event. Once registration closes (approximately two weeks before the event). Seeding will be based on the official VRS Rankings released by Valve in March 2026.
The seeding shall be based on the official VRS ranking released by Valve on March 2nd, 2026. The registered teams will begin in the Open LAN Group Stage on Day 1 to earn their place in the Play-offs.
...
The first stage will consist of four groups of four teams, where the top two teams from each group advance to the playoffs. This stage will follow a double-elimination bracket format (GSL), with the opening match played as a best-of-one (BO1) and the remaining rounds played as best-of-three (BO3).
The playoffs will be played in a single-elimination bracket with 8 teams, in BO3. On 24 and 25 March, the quarterfinals, semifinals and grand final will be played.
...
The tournament will feature two stages: group stage (GSL) and playoffs, both played offline (on LAN).
...
Each group will contain exactly one team from each pot. The live draw will be held on March 8, 2026, and broadcast on the official XPortal Esports twitch.tv channel - https://www.twitch.tv/xportalesports/
...
Group stage matches will be conducted in waves across available setups to ensure all matches can be completed within Day 1 (Group A and B) and Day 2 (Group C and D).
...
The Group Stage is expected to conclude by the evening of Day 1 and Day 2, after which advancing teams will be briefed for the Playoffs.

### Playoffs (Day 3 and Day 4)
...
Teams are eliminated only after one match loss.
